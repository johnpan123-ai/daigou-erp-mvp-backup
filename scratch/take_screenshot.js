...
async function run() {
  ...
  try {
    ...
    const artifactPath = 'C:/Users/小河馬/.gemini/antigravity/brain/4b09ad1d-184d-4c5b-9022-a60d7ad0d415/dashboard_screenshot.png';
    console.log(`Taking screenshot to ${artifactPath}...`);
