...
async function run() {
  ...
  try {
    ...
    await page.evaluate((data) => {
      ...
      if (data.erp_import_batches) localStorage.setItem('erp_import_batches', JSON.stringify(data.erp_import_batches));
    }, dbData);
    
    console.log('Navigating directly to import page...');
    await page.goto('http://localhost:5174/orders-import');
    await page.waitForTimeout(2000);

    const screenshotPath = 'C:/Users/小河馬/.gemini/antigravity/brain/4b09ad1d-184d-4c5b-9022-a60d7ad0d415/orders_import_screenshot.png';
